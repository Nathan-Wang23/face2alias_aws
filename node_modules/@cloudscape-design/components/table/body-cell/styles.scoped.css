...
.awsui_body-cell_c6tup_xpjfg_93:not(#\9) {
  ...
  border-top: var(--border-divider-list-width-um3zli, 1px) solid transparent;
...
.awsui_body-cell_c6tup_xpjfg_93.awsui_body-cell-editable_c6tup_xpjfg_130:not(#\9):not(.awsui_body-cell-edit-active_c6tup_xpjfg_130):focus-within::before {
  ...
  display: block;
  position: absolute;
  left: calc(-1 * calc(-1 * var(--space-scaled-xxs-t2t62i, 4px)));
  top: calc(-1 * calc(-1 * var(--space-scaled-xxs-t2t62i, 4px)));
  width: calc(100% + 2 * calc(-1 * var(--space-scaled-xxs-t2t62i, 4px)));
  height: calc(100% + 2 * calc(-1 * var(--space-scaled-xxs-t2t62i, 4px)));
