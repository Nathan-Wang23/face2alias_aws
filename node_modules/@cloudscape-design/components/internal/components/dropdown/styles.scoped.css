...
.awsui_dropdown-content-wrapper_qwoo0_1ru6x_93:not(#\9) {
  ...
  outline: none;
  box-shadow: var(--shadow-dropdown-qb4pc9, 0px 4px 20px 1px rgba(0, 7, 22, 0.1));
...
.awsui_dropdown-content-wrapper_qwoo0_1ru6x_93:not(#\9)::after {
  ...
  border: var(--border-field-width-riro62, 2px) solid var(--color-border-dropdown-container-rr4tpa, #9ba7b6);
  border-radius: var(--border-radius-dropdown-re1k6b, 8px);
  pointer-events: none;
}
