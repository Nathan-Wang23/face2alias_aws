    ...
    if (customTriggerBuilder) {
        ...
        trigger = (React.createElement("div", { role: "group", "aria-label": ariaLabel, className: styles['split-trigger-wrapper'] },
            React.createElement("div", { className: clsx(styles['trigger-item'], styles['split-trigger']), 
                ...
                React.createElement(InternalButton, Object.assign({ ref: mainActionRef }, mainActionProps, mainActionIconProps, { className: styles['trigger-button'], variant: "primary", ariaLabel: mainActionAriaLabel, formAction: "none" }), text)),
        ...
        trigger = (React.createElement("div", { className: styles['dropdown-trigger'] },
            React.createElement(InternalButton, Object.assign({ ref: triggerRef }, baseTriggerProps), children)));
    }
